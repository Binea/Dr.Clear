...
namespace DentalMedical.BLL
{
	...
	{
		private readonly IHDE_relation dal=DataAccess.CreateHDE_relation();
		public HDE_relation()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.HDE_relation GetModelByCache(Guid Id)
		{
			
			string CacheKey = "HDE_relationModel-" + Id;
			...
			return (DentalMedical.Model.HDE_relation)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.HDE_relation> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.HDE_relation> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.HDE_relation> modelList = new List<DentalMedical.Model.HDE_relation>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.HDE_relation model;
