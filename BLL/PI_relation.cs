...
namespace DentalMedical.BLL
{
	...
	{
		private readonly IPI_relation dal=DataAccess.CreatePI_relation();
		public PI_relation()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.PI_relation GetModelByCache(Guid Id)
		{
			
			string CacheKey = "PI_relationModel-" + Id;
			...
			return (DentalMedical.Model.PI_relation)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.PI_relation> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.PI_relation> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.PI_relation> modelList = new List<DentalMedical.Model.PI_relation>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.PI_relation model;
