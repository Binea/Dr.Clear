...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Iarea_BaseData dal=DataAccess.Createarea_BaseData();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.area_BaseData GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "area_BaseDataModel-" ;
			...
			return (DentalMedical.Model.area_BaseData)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.area_BaseData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.area_BaseData> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.area_BaseData> modelList = new List<DentalMedical.Model.area_BaseData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.area_BaseData model;
