...
namespace DentalMedical.BLL
{
	...
	/// dental_model
	/// </summary>
	public partial class dental_model
	{
		private readonly Idental_model dal=DataAccess.Createdental_model();
		public dental_model()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.dental_model GetModelByCache(Guid Id)
		{
			
			string CacheKey = "dental_modelModel-" + Id;
			...
			return (DentalMedical.Model.dental_model)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.dental_model> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.dental_model> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.dental_model> modelList = new List<DentalMedical.Model.dental_model>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.dental_model model;
        ...
        {
            return dal.update_model_flag(emrcode);
        }
