...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Iexpress_info dal=DataAccess.Createexpress_info();
		public express_info()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.express_info GetModelByCache(Guid Id)
		{
			
			string CacheKey = "express_infoModel-" + Id;
			...
			return (DentalMedical.Model.express_info)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.express_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.express_info> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.express_info> modelList = new List<DentalMedical.Model.express_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.express_info model;
