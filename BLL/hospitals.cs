...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Ihospitals dal=DataAccess.Createhospitals();
		public hospitals()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.hospitals GetModelByCache(Guid Id)
		{
			
			string CacheKey = "hospitalsModel-" + Id;
			...
			return (DentalMedical.Model.hospitals)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.hospitals> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.hospitals> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.hospitals> modelList = new List<DentalMedical.Model.hospitals>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.hospitals model;
        ...
        {
            return dal.gethospital_code(code);
        }
