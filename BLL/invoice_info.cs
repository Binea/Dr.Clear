...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Iinvoice_info dal=DataAccess.Createinvoice_info();
		public invoice_info()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.invoice_info GetModelByCache(Guid Id)
		{
			
			string CacheKey = "invoice_infoModel-" + Id;
			...
			return (DentalMedical.Model.invoice_info)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.invoice_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.invoice_info> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.invoice_info> modelList = new List<DentalMedical.Model.invoice_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.invoice_info model;
