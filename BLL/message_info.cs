...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Imessage_info dal=DataAccess.Createmessage_info();
		public message_info()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.message_info GetModelByCache(Guid Id)
		{
			
			string CacheKey = "message_infoModel-" + Id;
			...
			return (DentalMedical.Model.message_info)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.message_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.message_info> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.message_info> modelList = new List<DentalMedical.Model.message_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.message_info model;
        ...
        {
            return dal.validate_code(tel,code,mtype);
        }
        ...
        {
            return dal.senconds_message(tel);
        }
        ...
        {
            return dal.count_tel_ip(tel,ip);
        }
