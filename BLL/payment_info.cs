...
namespace DentalMedical.BLL
{
    ...
    {
        private readonly Ipayment_info dal = DataAccess.Createpayment_info();
        public payment_info()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public DentalMedical.Model.payment_info GetModelByCache(Guid Id)
        {

            string CacheKey = "payment_infoModel-" + Id;
            ...
            return (DentalMedical.Model.payment_info)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<DentalMedical.Model.payment_info> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<DentalMedical.Model.payment_info> DataTableToList(DataTable dt)
        {
            List<DentalMedical.Model.payment_info> modelList = new List<DentalMedical.Model.payment_info>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                DentalMedical.Model.payment_info model;
        ...
        public List<DentalMedical.Model.payment_info> Get_payment_List(Guid id)
        {
            return dal.Get_payment_List(id);
        }
