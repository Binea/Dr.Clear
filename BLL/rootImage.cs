...
namespace DentalMedical.BLL
{
	...
	{
		private readonly IrootImage dal=DataAccess.CreaterootImage();
		public rootImage()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.rootImage GetModelByCache(Guid Id)
		{
			
			string CacheKey = "rootImageModel-" + Id;
			...
			return (DentalMedical.Model.rootImage)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.rootImage> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.rootImage> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.rootImage> modelList = new List<DentalMedical.Model.rootImage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.rootImage model;
