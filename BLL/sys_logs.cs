...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Isys_logs dal=DataAccess.Createsys_logs();
		public sys_logs()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.sys_logs GetModelByCache(Guid Id)
		{
			...
			return (DentalMedical.Model.sys_logs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.sys_logs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.sys_logs> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.sys_logs> modelList = new List<DentalMedical.Model.sys_logs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.sys_logs model;
