...
namespace DentalMedical.BLL
{
	...
	{
		private readonly Ititles dal=DataAccess.Createtitles();
		public titles()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DentalMedical.Model.titles GetModelByCache(Guid Id)
		{
			
			string CacheKey = "titlesModel-" + Id;
			...
			return (DentalMedical.Model.titles)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.titles> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DentalMedical.Model.titles> DataTableToList(DataTable dt)
		{
			List<DentalMedical.Model.titles> modelList = new List<DentalMedical.Model.titles>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DentalMedical.Model.titles model;
