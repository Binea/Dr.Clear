...
namespace DentalMedical.SQLServerDAL
{
    ...
    /// 数据访问类:EMR_stream
    /// </summary>
    public partial class EMR_stream : IEMR_stream
    {
        public EMR_stream()
        { }
        #region  BasicMethod
        ...
        public bool Exists(Guid Id)
        {
            ...
            strSql.Append("select count(1) from EMR_stream");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(DentalMedical.Model.EMR_stream model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into EMR_stream(");
            strSql.Append("Id,EMR_Code,message,orderId,factoryRemark,createDate,createId,flag)");
            strSql.Append(" values (");
            strSql.Append("@Id,@EMR_Code,@message,@orderId,@factoryRemark,GETDATE(),@createId,@flag)");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier),
					new SqlParameter("@EMR_Code", SqlDbType.VarChar),
					new SqlParameter("@message", SqlDbType.VarChar),
					new SqlParameter("@orderId", SqlDbType.Int),
					new SqlParameter("@factoryRemark", SqlDbType.VarChar),
            ...
            parameters[4].Value = model.factoryRemark;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(DentalMedical.Model.EMR_stream model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update EMR_stream set ");
            ...
            parameters[3].Value = model.factoryRemark;
        ...
        public bool Delete(Guid Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from EMR_stream ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public DentalMedical.Model.EMR_stream GetModel(Guid Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,EMR_Code,message,orderId,factoryRemark,createDate,createId,modifyDate,modifyId,flag from EMR_stream ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;

            DentalMedical.Model.EMR_stream model = new DentalMedical.Model.EMR_stream();
        ...
        /// 得到一个对象实体
        /// </summary>
        public DentalMedical.Model.EMR_stream DataRowToModel(DataRow row)
        {
            DentalMedical.Model.EMR_stream model = new DentalMedical.Model.EMR_stream();
            if (row != null)
            {
                ...
                if (row["factoryName"] != null && row["factoryName"].ToString() != "")
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,EMR_Code,message,orderId,factoryRemark,createDate,createId,modifyDate,modifyId,flag ");
            strSql.Append(" FROM EMR_stream ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,EMR_Code,message,orderId,factoryRemark,createDate,createId,modifyDate,modifyId,flag ");
            strSql.Append(" FROM EMR_stream ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from EMR_stream T ");
        ...
        /// 增加一条数据
        /// </summary>
        public Hashtable Add_hash(DentalMedical.Model.EMR_stream model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into EMR_stream(");
            strSql.Append("Id,EMR_Code,message,orderId,factoryRemark,createDate,createId,flag)");
