...
namespace DentalMedical.SQLServerDAL
{
	...
	/// 数据访问类:FD_relation
	/// </summary>
	public partial class FD_relation:IFD_relation
	{
		public FD_relation()
		{}
		#region  BasicMethod
		...
		public bool Exists(Guid Id)
		{
			...
			strSql.Append("select count(1) from FD_relation");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(DentalMedical.Model.FD_relation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into FD_relation(");
			strSql.Append("Id,factory_Id,doctor_Id,cRemark,createDate,createId,flag)");
			strSql.Append(" values (");
			strSql.Append("@Id,@factory_Id,@doctor_Id,@cRemark,GETDATE(),@createId,@flag)");
			SqlParameter[] parameters = {
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DentalMedical.Model.FD_relation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update FD_relation set ");
		...
		public bool Delete(Guid Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from FD_relation ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public DentalMedical.Model.FD_relation GetModel(Guid Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,factory_Id,doctor_Id,cRemark,createDate,createId,modifyDate,modifyId,flag from FD_relation ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = Id;

			DentalMedical.Model.FD_relation model=new DentalMedical.Model.FD_relation();
		...
		/// 得到一个对象实体
		/// </summary>
		public DentalMedical.Model.FD_relation DataRowToModel(DataRow row)
		{
			DentalMedical.Model.FD_relation model=new DentalMedical.Model.FD_relation();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,factory_Id,doctor_Id,cRemark,createDate,createId,modifyDate,modifyId,flag ");
			strSql.Append(" FROM FD_relation ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,factory_Id,doctor_Id,cRemark,createDate,createId,modifyDate,modifyId,flag ");
			strSql.Append(" FROM FD_relation ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from FD_relation T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "FD_relation";
