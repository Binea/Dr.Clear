...
namespace DentalMedical.SQLServerDAL
{
	...
	/// 数据访问类:FE_relation
	/// </summary>
	public partial class FE_relation:IFE_relation
	{
		public FE_relation()
		{}
		#region  BasicMethod
		...
		public bool Exists(Guid Id)
		{
			...
			strSql.Append("select count(1) from FE_relation");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(DentalMedical.Model.FE_relation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into FE_relation(");
			strSql.Append("Id,factory_Id,doctor_Id,EMR_Code,createDate,createId,modifyDate,modifyId,flag)");
			...
			parameters[3].Value = model.EMR_Code;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DentalMedical.Model.FE_relation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update FE_relation set ");
		...
		public bool Delete(Guid Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from FE_relation ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public DentalMedical.Model.FE_relation GetModel(Guid Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,factory_Id,doctor_Id,EMR_Code,createDate,createId,modifyDate,modifyId,flag from FE_relation ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = Id;

			DentalMedical.Model.FE_relation model=new DentalMedical.Model.FE_relation();
		...
		/// 得到一个对象实体
		/// </summary>
		public DentalMedical.Model.FE_relation DataRowToModel(DataRow row)
		{
			DentalMedical.Model.FE_relation model=new DentalMedical.Model.FE_relation();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,factory_Id,doctor_Id,EMR_Code,createDate,createId,modifyDate,modifyId,flag ");
			strSql.Append(" FROM FE_relation ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from FE_relation T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "FE_relation";
