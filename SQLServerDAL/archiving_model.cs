...
{
    /// <summary>
    /// 数据访问类:archiving_model
    /// </summary>
    public partial class archiving_model : Iarchiving_model
    {
        public archiving_model()
        { }
        #region  BasicMethod
        ...
        public bool Exists(Guid Id)
        {
            ...
            strSql.Append("select count(1) from archiving_model");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(DentalMedical.Model.archiving_model model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into archiving_model(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(DentalMedical.Model.archiving_model model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update archiving_model set ");
        ...
        public bool Delete(Guid Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from archiving_model ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public DentalMedical.Model.archiving_model GetModel(Guid Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,EMR_Code,imagePath,model_status,orderId,createDate,createId,modifyDate,modifyId,flag from archiving_model ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;

            DentalMedical.Model.archiving_model model = new DentalMedical.Model.archiving_model();
        ...
        /// 得到一个对象实体
        /// </summary>
        public DentalMedical.Model.archiving_model DataRowToModel(DataRow row)
        {
            DentalMedical.Model.archiving_model model = new DentalMedical.Model.archiving_model();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM archiving_model ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from archiving_model T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "archiving_model";
