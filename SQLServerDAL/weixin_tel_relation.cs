...
{
    /// <summary>
    /// 数据访问类:weixin_tel_relation
    /// </summary>
    public partial class weixin_tel_relation : Iweixin_tel_relation
    {
        ...
        public bool Exists(Guid Id)
        {
            ...
            strSql.Append("select count(1) from weixin_tel_relation");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into weixin_tel_relation(");
            strSql.Append("Id,WeiXin,Tel,createDate,createId,modifyDate,modifyId,flag)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update weixin_tel_relation set ");
        ...
        public bool Delete(Guid Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from weixin_tel_relation ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;
        ...
        public DentalMedical.Model.weixin_tel_relation GetModel(Guid Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,WeiXin,Tel,createDate,createId,modifyDate,modifyId,flag from weixin_tel_relation ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.UniqueIdentifier,16)			};
            parameters[0].Value = Id;

            DentalMedical.Model.weixin_tel_relation model = new DentalMedical.Model.weixin_tel_relation();
        ...
        /// 得到一个对象实体
        /// </summary>
        public DentalMedical.Model.weixin_tel_relation DataRowToModel(DataRow row)
        {
            DentalMedical.Model.weixin_tel_relation model = new DentalMedical.Model.weixin_tel_relation();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,WeiXin,Tel,createDate,createId,modifyDate,modifyId,flag ");
            strSql.Append(" FROM weixin_tel_relation ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from weixin_tel_relation T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "weixin_tel_relation";
