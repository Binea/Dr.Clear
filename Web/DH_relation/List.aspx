<%@ Page Title="DH_relation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.DH_relation.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="department_Id" HeaderText="科室Id" SortExpression="department_Id" ItemStyle-HorizontalAlign="Center"  /> 
