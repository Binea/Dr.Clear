<%@ Page Title="HDE_relation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.HDE_relation.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="hospital_Id" HeaderText="医院Id" SortExpression="hospital_Id" ItemStyle-HorizontalAlign="Center"  /> 
