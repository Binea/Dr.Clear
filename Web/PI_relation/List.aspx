<%@ Page Title="PI_relation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.PI_relation.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="paymentId" HeaderText="paymentId" SortExpression="paymentId" ItemStyle-HorizontalAlign="Center"  /> 
