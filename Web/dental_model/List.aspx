<%@ Page Title="dental_model" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.dental_model.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="imagePath" HeaderText="图片路径(也有可能为二进制)" SortExpression="imagePath" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="model_status" HeaderText="模型状态" SortExpression="model_status" ItemStyle-HorizontalAlign="Center"  /> 
