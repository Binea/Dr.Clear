<%@ Page Title="express_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.express_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="companyApi" HeaderText="companyApi" SortExpression="companyApi" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="codeRole" HeaderText="codeRole" SortExpression="codeRole" ItemStyle-HorizontalAlign="Center"  /> 
