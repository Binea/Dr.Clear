<%@ Page Title="invoice_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.invoice_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="expressName" HeaderText="expressName" SortExpression="expressName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="expressCode" HeaderText="expressCode" SortExpression="expressCode" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ioId" HeaderText="ioId" SortExpression="ioId" ItemStyle-HorizontalAlign="Center"  /> 
