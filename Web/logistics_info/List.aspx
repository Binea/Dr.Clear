<%@ Page Title="logistics_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.logistics_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="EMR_Code" HeaderText="病历编号" SortExpression="EMR_Code" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="dsId" HeaderText="设计方案ID" SortExpression="dsId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="expressName" HeaderText="快递公司" SortExpression="expressName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="express_billCode" HeaderText="快递编号" SortExpression="express_billCode" ItemStyle-HorizontalAlign="Center"  /> 
