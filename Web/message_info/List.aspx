<%@ Page Title="message_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.message_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="mobilePhone" HeaderText="手机号" SortExpression="mobilePhone" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="mtype" HeaderText="短信类型" SortExpression="mtype" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="validation_Code" HeaderText="手机短信验证号" SortExpression="validation_Code" ItemStyle-HorizontalAlign="Center"  /> 
