<%@ Page Title="payment_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.payment_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="channel" HeaderText="渠道 支付宝等" SortExpression="channel" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="type" HeaderText="付款" SortExpression="type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="money" HeaderText="金额" SortExpression="money" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="bill_code" HeaderText="单号" SortExpression="bill_code" ItemStyle-HorizontalAlign="Center"  /> 
