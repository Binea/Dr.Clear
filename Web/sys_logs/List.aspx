<%@ Page Title="sys_logs" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.sys_logs.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="doctor_Id" HeaderText="doctor_Id" SortExpression="doctor_Id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LogsType" HeaderText="LogsType" SortExpression="LogsType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Entity" HeaderText="Entity" SortExpression="Entity" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="incident" HeaderText="incident" SortExpression="incident" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="IP" HeaderText="IP" SortExpression="IP" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="clientInfo" HeaderText="clientInfo" SortExpression="clientInfo" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="logmessage" HeaderText="logmessage" SortExpression="logmessage" ItemStyle-HorizontalAlign="Center"  /> 
