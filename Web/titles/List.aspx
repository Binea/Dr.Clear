<%@ Page Title="titles" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DentalMedical.Web.titles.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="titleName" HeaderText="职称" SortExpression="titleName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="titleIntroduction" HeaderText="简介" SortExpression="titleIntroduction" ItemStyle-HorizontalAlign="Center"  /> 
